...
inside the HTML comment tags (<!-- Comments -->).Comments can be multiline as well.
...
Output Format
Print the HTML tags, attributes and attribute values in order of their occurrence
from top to bottom in the given snippet.
