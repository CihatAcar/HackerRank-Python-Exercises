...
"""
total_country_stamps = int(input())
country_stamps = set()
for _ in range(total_country_stamps):
    country_stamps.add(input())

print(len(country_stamps))

# We could make this without using .add() method.
# We could use set comprehension method which can be done with two lines of code.
total_country_stamps = int(input())
country_stamps = {input() for _ in range(total_country_stamps)}
