...
It calls function score_words with the list of words
read from the input as the argument and prints the returned score to the output.
...
def score_words(words):
    ...
    for word in words:
        ...
        if num_vowels % 2 == 0:
            ...
            score += 1  # Here's the corrected line (Before it was ++score)
    return score
