...
This tool returns r length subsequences of elements
...
def combinations_with_replacement_string(s, k):
    # Create combinations
    combs_with_replacement = [''.join(c) for c in combinations_with_replacement(sorted(s), k)]
...
# Call function
combinations_with_replacement_string(s, k)
