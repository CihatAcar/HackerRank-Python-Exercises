...
A complex number z:
z = x + yj is completely determined by its real part x and imaginary part y.
Here, j is the imaginary unit.
A polar coordinate (r, @) is completely determined by modulus r and phase angle @.
