...
There are n words belonging to word group A. For each m words, check whether the word has appeared in group A or not.
Print the indices of each occurrence of m in group A. If it does not appear, print -1.

Example
Group A contains 'a', 'b', 'a' Group B contains 'a', 'c'
For the first word in group B, 'a', it appears at positions  and  in group A.
...
Output Format
Output m lines.
The ith line should contain the 1-indexed positions of the occurrences of the word separated by spaces.
...
# Calculate and print the positions of words in group B
word_positions(A, B)
