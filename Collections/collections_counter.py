...
def calculate_earnings(shoe_sizes, number_of_customers, customer_data):
    available_shoes = Counter(shoe_sizes)

    total_earnings = 0

    for customer in range(number_of_customers):
        desired_size, price = customer_data[customer]
...
number_of_shoes = int(input()) # This will be not used in calculation of earnings.
...
print(calculate_earnings(shoe_sizes, number_of_customers, customer_data))