...
# Get the number of operations (N) from the user
N = int(input())

# Get the operations as input and store them in a list
operations = [input().strip() for _ in range(N)]

# Perform the deque operations and print the elements of the deque
perform_deque_operations(operations)
